...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">تقرير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ فواتير المبيعات</span>
						</div>
					</div>
...
@section('content')
	<div class="row">
		<div class="col-lg-12 col-md-12">
			<div class="card">
				<div class="card-body">
					<form action="{{ route("search_sales") }}" method="POST">
						@csrf
						<div class="row">
							<div class="col-md-3">
									...
									<table class="table text-md-nowrap text-center" id="">
										<thead class="">
											<tr >
												...
												<th class="wd-20p border-bottom-0">قيمة التخفيض</th>
