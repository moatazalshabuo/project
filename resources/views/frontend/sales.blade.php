                        ...
                        <form id="input-item">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-6">
                                    <label class="m2">الكمية</label>
                                    <input class="form-control m2" required @if ($data->status == 0) disabled @endif
                                        placeholder="الكمية" id="quant" name="quant" type="number">
                                    <div class="d-flex">
                                        <div class="form-group">
                                            <label class="m3">الطول</label>
                                            <input type="number" @if ($data->status == 0) disabled @endif
                                                class="form-control  m3 m-1" id="length" disabled name="length"
                                                placeholder="طول">
                                        </div>
                                        <div class="form-group">
                                            <label class="m3">العرض</label>
                                            <input type="number" @if ($data->status == 0) disabled @endif
                                                class="form-control mateFiled m3 m-1" id="width" disabled name="width"
                                                placeholder="العرض">
                                        </div>
                                        <div class="form-group">
                                            <label class="m3">الكمية</label>
                                            <input class="form-control m3 m-1" required
                                                @if ($data->status == 0) disabled @endif placeholder="الكمية"
                                                id="quant1" name="quant1" value="1" type="number">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="descripe" id="descripe"
                                        @if ($data->status == 0) disabled @endif class="form-control">
                                </div>
                                <div class="col-md-1">
                                    <br>
                                    <button class="btn btn-primary" id="addItem" type="button">
                                        <span class="spinner-border spinner-border-sm sp" style="display: none"></span><span
            ...
            $(function() {
                ...
                function add_item_sale() {
                    ...
                    $.ajax({
                        url: "{{ route('add_item') }}",
                        type: "POST",
                        data: $("#input-item").serialize() + "&price=" + $("#price").val() +
                            "&id={{ $data->id }}",
                        success: function(r) {
                            $("#addItem .sp").hide()
                            $("#addItem .text").show()
                    ...
                    $.ajax({
                        ...
                        success: function(r) {
                            ...
                            if (data['type'] == 1) {
                                ...
                                if (data['type_q'] == 3) {
                                    type_q(3)
                                    $('#quant1').val(parseFloat(data['count']))
                                    $("#length").val(parseFloat(data['length']))
                                    $('#width').val(parseFloat(data['width']))
                                }
