...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">حركة الاصناف</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"></span>
						</div>
					</div>
...
@section('content')
	<div class="row">
		<div class="col-lg-12 col-md-12">
			<div class="card">
				<div class="card-body">
					<form action="{{ route("search_moveraw") }}" method="POST">
						@csrf
						<div class="row">
							<div class="col-md-4">
							...
							<div class="card-body" style="overflow-y: scroll;height:500px">
								<div class="table-responsive">
									<table class="table text-md-nowrap text-center" id="">
										<thead>
											<tr>
												<th class="wd-15p border-bottom-0">رقم المادة</th>
											...
											@if ( session()->get('data'))
												@foreach (session()->get('data') as $item)
													<tr>
														...
														<td>{{ $item['name'] }}</td>
														<td>@if ($item['type'] == 2)
															<a href="{{ route('salesbill',$item['id_bill']) }}"> فاتورة مبيعات رقم{{ $item['id_bill'] }} </a>
														@elseif($item['type']== 1)
