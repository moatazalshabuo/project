...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الاصناف</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ ادارة
                    الاصناف</span>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header bg-primary">
                    <h6 class="modal-title text-white">اضافة صنف</h6><button aria-label="Close" class="close"
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">ادارة بيانات منتج</h6><button aria-label="Close" class="close clo"
                        data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex">
                                            ...
                                            <input type="number" class="form-control mateFiled m3 m-1" id="width"
                                                disabled name="width" placeholder="العرض">
                                        </div>
                                        {{-- <input type="number" class="form-control " id="quantity" name="quantity" required> --}}

                                        <input type="number" placeholder="كمية" name="quan"
                                            class="form-control mateFiled m2">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="اسم الخدمة" class="form-control"
                                                name="work_name" id="work_name">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <label>السعر </label>
                                        <input type="number" placeholder="السعر" name="price_work" id="work_price"
                                            class="form-control">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="top">
                                <form id="form-edit">
                                    ...
                                    <div class="row">
                                        <div class="form group col-8">
                                            <input type="text" name="name" id="name" placeholder="اسم الصنف"
                                                class="form-control">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>التكلفة</label>
                                                <input type="number" disabled id="cost" value="0"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
