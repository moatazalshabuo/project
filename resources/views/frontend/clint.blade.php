...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">كشف حساب زبون </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"></span>
						</div>
					</div>
					...
					<div class="col-md-12">
						<div class="card">
											...
											@if ( session()->get('data'))
												@foreach (session()->get('data') as $item)
													<tr>
														<td>
															@if ( $item['type_n'] == '2')
															<a href="{{ route('salesbill',$item['id_bill']) }}"> فاتورة المبيعات رقم{{ $item['id_bill'] }} </a>
															@else
							...
							<div class="card-footer">
								...
								@endif</span></button>
								<button class="btn btn-pink-gradient">متبقي عليه : <span>@if (session()->get('Residual_s'))
