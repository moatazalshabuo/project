...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">كشف حساب مورد </h4><span
        ...
        <div class="col-md-12">
            <div class="card">
                    ...
                    <form action="{{ route('search_cust') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <select class="form-control sel" name="custom">
                ...
                <div class="card-footer">
                    ...
                    <button class="btn btn-pink-gradient">متبقي له : <span>
