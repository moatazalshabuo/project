                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input id="email" type="email"
                                    ...
                                    placeholder="البريد الالكتروني" name="email" value="{{ old('email',$user->email) }}" required
                                    autocomplete="email">
