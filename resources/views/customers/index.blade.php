...
@section('content')
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="col-sm-6 col-md-4 col-xl-3">
                        <button class="btn btn-primary" data-target="#select2modal" data-toggle="modal">اضافة مورد</button>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        @endforeach
                    @else
                        <span> لايوجد موردين مخزنين بالنظام</span>
                        @endif
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">تعديل بيانات مورد</h5>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ url('customers/update') }}" method="post" autocomplete="off">
                        {{ method_field('patch') }}
                        @csrf
                        <div class="form-group">
    ...
    <div class="modal fade" id="modaldemo9" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">حذف مورد</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
