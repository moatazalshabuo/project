...
class Products extends Controller
{
    ...
    public function add_pro(Request $request)
    {
        ...
        $massage = [
            'name.required' => "اسم الصنف لايمكن ان يكون فارغ",
    ...
    {
        $mymaterial = material_product::join("rawmaterials", "rawmaterials.id", "=", "proudct_material.rawid")
            ->select(["rawmaterials.material_name", "rawmaterials.material_type", "proudct_material.*"])
    ...
    public function addMeta(Request $request)
    {
        ...
        $mate = rawmaterials::find($request->s_name);

        $quantity = $request->quan / ($mate->hiegth * $mate->width);
